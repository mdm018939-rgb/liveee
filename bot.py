...
# 🎯 শুধু এই সার্ভিসগুলো পাঠানো হবে
ALLOWED_SERVICES = ["facebook", "tiktok", "imo", "telegram", "whatsapp", "discord"]
                    ...
                    if should_send:
                        ...
                        for service in services:
                            try:
                                ...
                                # ✅ শুধু ALLOWED_SERVICES-এ থাকলে প্রসেস করো, নাহলে স্কিপ
                                if sid.lower() not in ALLOWED_SERVICES:
                                    continue
