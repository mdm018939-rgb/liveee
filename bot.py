...
last_sent_hashes = {}  # প্রতিটি সার্ভিসের নিজস্ব হ্যাশ ট্র্যাক করার জন্য

def monitor_liveaccess():
    """Liveaccess API monitoring"""
    global last_sent_time, last_response_hash, last_sent_hashes
                    ...
                    if should_send:
                        ...
                        for service_index, service in enumerate(services):
                            try:
                                ...
                                # ✅ এই নির্দিষ্ট সার্ভিসের ডেটা আগেরটার সাথে একই কিনা চেক করো
                                service_hash = hash(json.dumps(service, sort_keys=True))
                                if last_sent_hashes.get(sid) == service_hash:
                                    continue  # ডেটা অপরিবর্তিত, স্কিপ করো
                                last_sent_hashes[sid] = service_hash
